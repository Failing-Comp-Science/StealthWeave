...
> **Behavioral deep-dive** (what each reference detects/embeds/frames/fails on, what to copy vs
> avoid) lives in `docs/REFERENCE_REVIEW.md` — read it alongside this section.
